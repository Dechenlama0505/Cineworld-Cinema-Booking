...
public class MovieBooking extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        btnsortseatdescendingg = new javax.swing.JButton();
        ...
        btnsortseatdescendingg.setBackground(new java.awt.Color(204, 177, 139));
        btnsortseatdescendingg.setForeground(new java.awt.Color(255, 255, 255));
        btnsortseatdescendingg.setText("Sort By SeatA");
        btnsortseatdescendingg.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(255, 255, 255))); // NOI18N
        btnsortseatdescendingg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnsortseatdescendingggActionPerformed(evt);
            }
        });
            ...
            .addGroup(JPNLbookingLayout.createSequentialGroup()
                ...
                .addGroup(JPNLbookingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(JPNLbookingLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnsortseatdescendingg)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnsortseatdescendingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsortseatdescendingActionPerformed
        ...
        List<MovieModel> sortedList = mergeSort.sortBySeatNo(movieList, false); // true for descending order
        ...
        // Show success dialog
        showDialogBox("Sorted by Seat No in descending order successfully.", "Success", JOptionPane.INFORMATION_MESSAGE); 
    ...
    private void btnsortseatdescendingggActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsortseatdescendingggActionPerformed
        // Create an instance of the MergeSort class
    MergeSort mergeSort = new MergeSort();

    // Sort the list by seat number in ascending order
    List<MovieModel> sortedList = mergeSort.sortBySeatNo(movieList, true); // false for ascending order
    ...
    // Show success dialog
    showDialogBox("Sorted by Seat Number in ascending order successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_btnsortseatdescendingggActionPerformed
    ...
    try {
        ...
        JOptionPane.showMessageDialog(
            this,
            "An error occurred while performing the search: " + e.getMessage(),
            "Error",
            JOptionPane.ERROR_MESSAGE
        );
        e.printStackTrace();
...
private boolean isSearchPerformed = false;
   ...
   private void loadListToTable(LinkedList<MovieModel> movieList) {
    ...
    private javax.swing.JButton btnsortseatdescendingg;
